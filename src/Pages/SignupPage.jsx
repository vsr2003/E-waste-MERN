...
function SignupPage() {
  ...
  return (
    ...
    <div class="bg-white relative lg:py-20 h-[80vh] ">
              ...
              <div class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                <div class="relative">
                  <p class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600
                      absolute">Name</p>
                  <input placeholder="John" type="text" name="Name" value={formData.Name} onChange={handleChange} class="border placeholder-gray-400 focus:outline-none
                ...
                <div class="relative">
                  ...
                  <input placeholder="123@ex.com" type="email" name="email" value={formData.email} onChange={handleChange} class="border placeholder-gray-400 focus:outline-none
                      focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                      border-gray-300 rounded-md"/>
                </div>
                <div class="relative">
                  <p class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600
                      absolute">Password</p>
                  <input placeholder="Password" type="password" name="password" value={formData.password} onChange={handleChange} class="border placeholder-gray-400 focus:outline-none
                      focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                      border-gray-300 rounded-md"/>
                </div>

                <p className=" text-red-800 font-semibold "> {showError} </p>

                <div class="relative">
                  <button onClick={submitHandler} class="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500
