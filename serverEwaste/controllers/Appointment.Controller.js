...
const {generateTicketNumber}  = require("../utils/shortUIDgenerator") ;
const {sendEmail} = require("../utils/mailSender");
const {AppointmentMailTemplate} = require('../MailTemplates/Appointment');
...
exports.getAppointmentDetailsByTicketOrEmail = async(req,res) => {
    try {
...
exports.processAppointment = async(req,res) => {
    try {
