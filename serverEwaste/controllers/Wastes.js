...
const Waste = require("../models/Wastes");

exports.getEwastesCategory = async(req,res) => {
    try {
...
exports.getSelectedCategoryWasteInfo = async(req,res) => {
    try {
...
exports.getDeviceDetailsById = async(req,res) => {
    try {
